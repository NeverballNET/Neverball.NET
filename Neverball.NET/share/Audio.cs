...
namespace Neverball.NET
{
    public class Audio
    {
        ...
        public static void audio_music_play(string filename)
        {
        }


        public static void audio_music_stop()
        {
        }


        public static void audio_music_fade_to(float t, string filename)
        {
        }


        public static void audio_music_fade_out(float t)
        {
        }
    }
}
